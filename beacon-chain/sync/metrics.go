...
var (
	...
	arrivalBlockPropagationHistogram = promauto.NewHistogram(
		prometheus.HistogramOpts{
			...
			Buckets: []float64{100, 200, 300, 500, 1000, 1500, 2000, 4000, 8000, 12000},
		},
	)
	arrivalMevBoostBlockPropagationHistogram = promauto.NewHistogram(
		prometheus.HistogramOpts{
			Name:    "mev_block_arrival_latency_milliseconds",
			Help:    "Captures blocks propagation time. Blocks arrival in milliseconds distribution",
			Buckets: []float64{100, 200, 300, 500, 1000, 1500, 2000, 4000, 8000, 12000},
		},
	)
