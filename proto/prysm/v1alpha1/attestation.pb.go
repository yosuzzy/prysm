...
type LatencyAttestations struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Messages []*LatencyAttestations_LatencyAttestation `protobuf:"bytes,1,rep,name=messages,proto3" json:"messages,omitempty"`
}

func (x *LatencyAttestations) Reset() {
	*x = LatencyAttestations{}
	if protoimpl.UnsafeEnabled {
...
func (x *LatencyAttestations) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LatencyAttestations) ProtoMessage() {}

func (x *LatencyAttestations) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_attestation_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LatencyAttestations.ProtoReflect.Descriptor instead.
func (*LatencyAttestations) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_attestation_proto_rawDescGZIP(), []int{5}
}

func (x *LatencyAttestations) GetMessages() []*LatencyAttestations_LatencyAttestation {
	if x != nil {
		return x.Messages
	}
	return nil
...
type LatencyAttestations_LatencyAttestation struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	CommitteeIndex github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.CommitteeIndex `protobuf:"varint,1,opt,name=committee_index,json=committeeIndex,proto3" json:"committee_index,omitempty" cast-type:"github.com/prysmaticlabs/prysm/v3/consensus-types/primitives.CommitteeIndex"`
...
func (x *LatencyAttestations_LatencyAttestation) Reset() {
	*x = LatencyAttestations_LatencyAttestation{}
	if protoimpl.UnsafeEnabled {
...
func (x *LatencyAttestations_LatencyAttestation) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LatencyAttestations_LatencyAttestation) ProtoMessage() {}

func (x *LatencyAttestations_LatencyAttestation) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_attestation_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LatencyAttestations_LatencyAttestation.ProtoReflect.Descriptor instead.
func (*LatencyAttestations_LatencyAttestation) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_attestation_proto_rawDescGZIP(), []int{5, 0}
}

func (x *LatencyAttestations_LatencyAttestation) GetCommitteeIndex() github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.CommitteeIndex {
	if x != nil {
		return x.CommitteeIndex
	}
	return github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.CommitteeIndex(0)
...
func (x *LatencyAttestations_LatencyAttestation) GetValidatorIndex() github_com_prysmaticlabs_prysm_v3_consensus_types_primitives.ValidatorIndex {
	if x != nil {
...
func (x *LatencyAttestations_LatencyAttestation) GetAggregated() bool {
	if x != nil {
		return x.Aggregated
	}
	return false
...
func (x *LatencyAttestations_LatencyAttestation) GetLatency() uint64 {
	if x != nil {
		return x.Latency
	}
	return 0
...
var file_proto_prysm_v1alpha1_attestation_proto_rawDesc = []byte{
	...
	,
	...
	0x61, 0x74, 0x6f, 0x72, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x1e, 0x0a, 0x0a, 0x61, 0x67, 0x67,
	0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x61,
	0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x6c, 0x61, 0x74,
	0x65, 0x6e, 0x63, 0x79, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x07, 0x6c, 0x61, 0x74, 0x65,
	0x6e, 0x63, 0x79, 0x42, 0x9b, 0x01, 0x0a, 0x19, 0x6f, 0x72, 0x67, 0x2e, 0x65, 0x74, 0x68, 0x65,
...
var file_proto_prysm_v1alpha1_attestation_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_prysm_v1alpha1_attestation_proto_goTypes = []interface{}{
	...
	(*LatencyAttestations)(nil),                    // 5: ethereum.eth.v1alpha1.LatencyAttestations
	(*LatencyAttestations_LatencyAttestation)(nil), // 6: ethereum.eth.v1alpha1.LatencyAttestations.LatencyAttestation
}
var file_proto_prysm_v1alpha1_attestation_proto_depIdxs = []int32{
	...
	6, // 5: ethereum.eth.v1alpha1.LatencyAttestations.messages:type_name -> ethereum.eth.v1alpha1.LatencyAttestations.LatencyAttestation
...
func file_proto_prysm_v1alpha1_attestation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_prysm_v1alpha1_attestation_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LatencyAttestations); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_prysm_v1alpha1_attestation_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LatencyAttestations_LatencyAttestation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
