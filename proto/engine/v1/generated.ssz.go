...
// Hash: 77b4eabb83506ed4c6e31aebbb4d25347a256130749e91f6d5da202a6b284c0b
package enginev1
...
func (e *ExecutionPayloadElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (17) 'Exits'
	if size := len(e.Exits); size > 16 {
		err = ssz.ErrListTooBigFn("--.Exits", size, 16)
		return
	}
...
func (e *ExecutionPayloadElectra) UnmarshalSSZ(buf []byte) error {
	...
	// Field (17) 'Exits'
	{
		...
		e.Exits = make([]*ExecutionLayerExit, num)
		for ii := 0; ii < num; ii++ {
			if e.Exits[ii] == nil {
				e.Exits[ii] = new(ExecutionLayerExit)
			}
			if err = e.Exits[ii].UnmarshalSSZ(buf[ii*68 : (ii+1)*68]); err != nil {
				return err
			}
		}
	}
...
func (e *ExecutionPayloadHeaderElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (17) 'ExitsRoot'
	if size := len(e.ExitsRoot); size != 32 {
		err = ssz.ErrBytesLengthFn("--.ExitsRoot", size, 32)
		return
	}
	dst = append(dst, e.ExitsRoot...)
...
func (e *ExecutionPayloadHeaderElectra) UnmarshalSSZ(buf []byte) error {
	...
	// Field (17) 'ExitsRoot'
	if cap(e.ExitsRoot) == 0 {
		e.ExitsRoot = make([]byte, 0, len(buf[584:616]))
	}
	e.ExitsRoot = append(e.ExitsRoot, buf[584:616]...)
...
// MarshalSSZ ssz marshals the ExecutionLayerExit object
func (e *ExecutionLayerExit) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(e)
}

// MarshalSSZTo ssz marshals the ExecutionLayerExit object to a target array
func (e *ExecutionLayerExit) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
...
// UnmarshalSSZ ssz unmarshals the ExecutionLayerExit object
func (e *ExecutionLayerExit) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size != 68 {
		return ssz.ErrSize
...
// SizeSSZ returns the ssz encoded size in bytes for the ExecutionLayerExit object
func (e *ExecutionLayerExit) SizeSSZ() (size int) {
	size = 68
	return
}

// HashTreeRoot ssz hashes the ExecutionLayerExit object
func (e *ExecutionLayerExit) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(e)
}

// HashTreeRootWith ssz hashes the ExecutionLayerExit object with a hasher
func (e *ExecutionLayerExit) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
