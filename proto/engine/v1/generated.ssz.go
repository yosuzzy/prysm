...
// Hash: 9146b171dad00fe5a3f17b5db75f5937297890fa49cef6e33fa25bc06e1a5456
package enginev1
...
func (e *ExecutionPayloadHeaderElectra) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (17) 'WithdrawalRequestsRoot'
...
func (e *ExecutionPayloadHeaderElectra) UnmarshalSSZ(buf []byte) error {
	...
	if cap(e.WithdrawalRequestsRoot) == 0 {
		e.WithdrawalRequestsRoot = make([]byte, 0, len(buf[584:616]))
	}
	e.WithdrawalRequestsRoot = append(e.WithdrawalRequestsRoot, buf[584:616]...)
