...
def prysm_deps():
    ...
    go_repository(
        ...
        sum = "h1:jDyQvQjauRyb7TJAF9W7J3NOjn3ukXahd3l+rd1Fak8=",
        version = "v0.3.2-0.20231019020040-748283cced54",
    )
    ...
    go_repository(
        ...
        sum = "h1:UsDsJSV7/j0C4aGqECXoPvdL6a6y7myXMptcnQjflEY=",
        version = "v1.10.10-0.20231019143932-4d161dee0c4c",
    )
